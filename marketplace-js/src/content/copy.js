export const copyByLanguage = {
    en: {
        common: {
            ...
            noResults: 'No listings match that search yet.',
        ...
        seller: {
            ...
            createSummary: 'Complete the product details below. New listings enter the seller review queue before they go live, and prices are entered in BHD by default.',
    ...
    ar: {
        common: {
            ...
            noResults: 'لا توجد منتجات مطابقة لهذا البحث حتى الآن.',
        ...
        seller: {
            ...
            createSummary: 'أكمل تفاصيل المنتج أدناه. يتم إرسال المنتجات الجديدة أولًا إلى قائمة مراجعة البائع قبل نشرها، ويتم إدخال الأسعار بعملة الدينار البحريني BHD افتراضيًا.',
...
export const translateRoleLabel = (role, language) => roleLabels[language][role];
export const translateListingStatus = (status, language) => listingStatusLabels[language][status];
export const translateOrderStatus = (status, language) => orderStatusLabels[language][status];
export const translateCatalogText = (value, language) => language === 'ar' ? catalogTranslations[value] ?? value : value;
